...
module.exports = {
  ...
  custom_commands_path: [path.join('nightwatch', 'commands')],
  ...
  test_settings: {
    ...
    "cucumber-js": {
      ...
      test_runner: {
        ...
        options: {
          ...
          feature_path:
              "node_modules/nightwatch/examples/cucumber-js/*/*.feature", // start the webdriver session automatically (enabled by default)
    ...
    saucelabs: {
      ...
      desiredCapabilities: {
        "sauce:options": {
          ...
          screenResolution: "1280x1024", // https://docs.saucelabs.com/dev/cli/sauce-connect-proxy/#--region
          // region: 'us-west-1'
    ...
    selenium_server: {
      ...
      selenium: {
        ...
        port: 4444,
        server_path: "",
        // Leave empty if @nightwatch/selenium-server is installed
        command: "standalone",
        // Selenium 4 only
        cli_args: {
